...
- HMC is a variation on the Metropolis-Hastings (M-H) algorithm, but it uses the gradient of the distribution to more more quickly to areas of high density. 
- NUTS further improves on HMC by branching out in many directions at once and avoiding repeated visits to the same area of the posterior. 
